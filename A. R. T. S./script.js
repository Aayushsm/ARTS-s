...
function getAnswer(question) {
    ...
    const students = ["student count", "students count", "student's count", "how many students", "how many students study", "count of students","students"];
    ...
    const facilities = ["facilities", "what are the facilities", "facility","aminities"];
    ...
    const contact = ["what are the contact details","contact","about","college information"];
    ...
    const website = ["college website","sitp website","website"];
...
function getcontact(){
    const contact = [
        "• Landline -(02322)253050/55/71",
        "• Fax - +91-(02322)252027",
        "• contact@sitpolytechnic.org",
    ];
    return contact.join("\n\n");
}
function getfees(){
